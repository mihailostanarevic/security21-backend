package com.project.securitybackend.security;
...
@SuppressWarnings({"unused", "FieldMayBeFinal", "SpellCheckingInspection", "SpringJavaAutowiredFieldsWarningInspection"})
@Component
